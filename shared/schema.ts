...
export const borrowerInfoSchema = z.object({
  ...
  priorResidenceType: z.enum(["owned", "rental", "other"]).optional(),
  ...
  priorResidenceType2: z.enum(["owned", "rental", "other"]).optional(),
...
export const newRefinanceLoanSchema = z.object({
  ...
  rateLockStatus: z.string().optional(),
  rateLockDate: z.string().optional(),
  rateLockDateToggle: z.boolean().optional(),
  rateLockExpiration: z.string().optional(),
  rateLockExpirationToggle: z.boolean().optional(),
  lenderCredit: z.string().optional(),
  brokerCreditToggle: z.boolean().optional(),
  interestRate: z.string().optional(),
  principalAndInterestPayment: z.string().optional(),
  principalInterestPaymentToggle: z.boolean().optional(),
  taxInsurancePayment: z.string().optional(),
  taxInsurancePaymentSelector: z.string().optional(),
  totalMonthlyPayment: z.string().optional(),
...
export const newPurchaseLoanSchema = z.object({
  ...
  loanTerm: z.string().optional(),
  prepaymentPenalty: z.string().optional(),
  cashOutAmount: z.string().optional(), // Seller Credit / Other Credit
  cashOutAmountToggle: z.boolean().optional(),
  // Rate Details Section fields
  midFico: z.string().optional(),
  rateLockStatus: z.string().optional(),
