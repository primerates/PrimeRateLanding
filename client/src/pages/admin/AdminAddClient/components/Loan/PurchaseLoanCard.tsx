...
import PurchaseLoanForm from './PurchaseLoanForm';
import DeleteConfirmationDialog from '../../dialogs/DeleteConfirmationDialog';

interface PurchaseLoanCardProps {
  loanId: string;
    ...
    <>
      <Card className={`transition-all duration-700 ${getBorderStyles()}`}>
        <Collapsible open={isExpanded} onOpenChange={handleExpandToggle}>
          ...
          <CollapsibleContent>
            <CardContent>
              <PurchaseLoanForm loanId={loanId} />
            </CardContent>
          </CollapsibleContent>
        </Collapsible>
      </Card>
      ...
      <DeleteConfirmationDialog
        ...
        description="Are you sure you want to remove this purchase loan? This will clear all entered data for this loan. This action cannot be undone."
...
export default PurchaseLoanCard;
