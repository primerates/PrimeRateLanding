            ...
            <Collapsible open={isBorrowerOpen} onOpenChange={setIsBorrowerOpen}>
              ...
              <CollapsibleContent>
                <CardContent className="space-y-6 pt-6">
                  ...
                  <Card className="bg-gradient-to-br from-purple-800 to-violet-900 border-purple-600/50 hover:border-purple-500/70 mt-6">
                    <CardContent className="pt-6">
                      <div className="grid grid-cols-1 md:grid-cols-12 gap-4">
                        <div className="space-y-2 md:col-span-3">
                          <Label htmlFor="street" className="text-purple-200 font-semibold">Street Address</Label>
                          <Input
                            id="street"
                            value={street}
                            onChange={(e) => setStreet(e.target.value)}
                            className="bg-purple-900/50 text-white border-purple-500/30 focus:border-purple-400 placeholder:text-purple-300/50"
                            data-testid="input-street"
                          />
                        </div>
                        
                        <div className="space-y-2 md:col-span-1">
                          <Label htmlFor="unit" className="text-purple-200 font-semibold">Unit/Apt</Label>
                          <Input
                            id="unit"
                            value={unit}
                        ...
                        <div className="space-y-2 md:col-span-2">
                          <Label htmlFor="city" className="text-purple-200 font-semibold">City</Label>
                          <Input
                            id="city"
                            value={city}
                        ...
                        <div className="space-y-2 md:col-span-1">
                          <Label htmlFor="state" className="text-purple-200 font-semibold">State</Label>
                          <Input
                            id="state"
                            value={state}
                        ...
                        <div className="space-y-2 md:col-span-1">
                          <Label htmlFor="zipCode" className="text-purple-200 font-semibold">ZIP Code</Label>
                          <Input
                            id="zipCode"
                            value={zipCode}
                        ...
                        <div className="space-y-2 md:col-span-1">
                          <Label htmlFor="county" className="text-purple-200 font-semibold">County</Label>
                          <Input
                            id="county"
                            value={county}
                        ...
                        <div className="space-y-2 md:col-span-1">
                          <Label htmlFor="fromDate" className="text-purple-200 font-semibold">From</Label>
                          <Input
                            id="fromDate"
                            value={fromDate}
                            ...
                            placeholder="mm/dd/yyyy"
                            maxLength={10}
                            className="bg-purple-900/50 text-white border-purple-500/30 focus:border-purple-400 placeholder:text-purple-300/50 !text-[13px] placeholder:text-[10px]"
                        ...
                        <div className="space-y-2 md:col-span-1">
                          <div className="flex items-center justify-between mb-2">
                            <Label htmlFor="toDate" className="text-sm text-purple-200 font-semibold">
                        ...
                        <div className="space-y-2 md:col-span-1">
                          <Label htmlFor="duration" className="text-sm text-purple-200 font-semibold">Duration</Label>
                          <Input
                            id="duration"
                            value="0 Yrs 0 Mos"
                            readOnly
                            className="bg-purple-900/50 text-purple-300 border-purple-500/30 cursor-not-allowed !text-[13px]"
