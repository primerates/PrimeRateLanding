        ...
        <Card>
          ...
          <CardContent>
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground">
              <li>Add new vendors to the system</li>
              <li>Manage vendor contact information and services</li>
              <li>Track vendor performance and ratings</li>
              <li>Assign vendors to specific loan types</li>
            </ul>
          </CardContent>
        </Card>
      </div>
