      ...
      <div className="container mx-auto px-6 py-8">
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <Tabs defaultValue="client" className="space-y-6">
            <TabsList className="grid w-full grid-cols-9 bg-transparent h-auto p-0 relative border-b border-gray-200">
              <TabsTrigger value="client" data-testid="tab-client" className="relative bg-transparent text-gray-500 hover:text-black data-[state=active]:text-black data-[state=active]:bg-transparent border-0 rounded-none py-3 px-4 font-medium transition-colors duration-200 after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-red-500 after:transition-all after:duration-300 hover:after:w-full data-[state=active]:after:w-full">Borrower</TabsTrigger>
              <TabsTrigger value="income" data-testid="tab-income" className="relative bg-transparent text-gray-500 hover:text-black data-[state=active]:text-black data-[state=active]:bg-transparent border-0 rounded-none py-3 px-4 font-medium transition-colors duration-200 after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-red-500 after:transition-all after:duration-300 hover:after:w-full data-[state=active]:after:w-full">Income</TabsTrigger>
              <TabsTrigger value="property" data-testid="tab-property" className="relative bg-transparent text-gray-500 hover:text-black data-[state=active]:text-black data-[state=active]:bg-transparent border-0 rounded-none py-3 px-4 font-medium transition-colors duration-200 after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-red-500 after:transition-all after:duration-300 hover:after:w-full data-[state=active]:after:w-full">Property</TabsTrigger>
              <TabsTrigger value="loan" data-testid="tab-loan" className="relative bg-transparent text-gray-500 hover:text-black data-[state=active]:text-black data-[state=active]:bg-transparent border-0 rounded-none py-3 px-4 font-medium transition-colors duration-200 after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-red-500 after:transition-all after:duration-300 hover:after:w-full data-[state=active]:after:w-full">Loan</TabsTrigger>
              <TabsTrigger value="credit" data-testid="tab-credit" className="relative bg-transparent text-gray-500 hover:text-black data-[state=active]:text-black data-[state=active]:bg-transparent border-0 rounded-none py-3 px-4 font-medium transition-colors duration-200 after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-red-500 after:transition-all after:duration-300 hover:after:w-full data-[state=active]:after:w-full">Credit</TabsTrigger>
              <TabsTrigger value="status" data-testid="tab-status" className="relative bg-transparent text-gray-500 hover:text-black data-[state=active]:text-black data-[state=active]:bg-transparent border-0 rounded-none py-3 px-4 font-medium transition-colors duration-200 after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-red-500 after:transition-all after:duration-300 hover:after:w-full data-[state=active]:after:w-full">Status</TabsTrigger>
              <TabsTrigger value="vendors" data-testid="tab-vendors" className="relative bg-transparent text-gray-500 hover:text-black data-[state=active]:text-black data-[state=active]:bg-transparent border-0 rounded-none py-3 px-4 font-medium transition-colors duration-200 after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-red-500 after:transition-all after:duration-300 hover:after:w-full data-[state=active]:after:w-full">Vendors</TabsTrigger>
              <TabsTrigger value="quote" data-testid="tab-quote" className="relative bg-transparent text-gray-500 hover:text-black data-[state=active]:text-black data-[state=active]:bg-transparent border-0 rounded-none py-3 px-4 font-medium transition-colors duration-200 after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-red-500 after:transition-all after:duration-300 hover:after:w-full data-[state=active]:after:w-full">Quote</TabsTrigger>
              <TabsTrigger value="notes" data-testid="tab-notes" className="relative bg-transparent text-gray-500 hover:text-black data-[state=active]:text-black data-[state=active]:bg-transparent border-0 rounded-none py-3 px-4 font-medium transition-colors duration-200 after:absolute after:bottom-0 after:left-0 after:w-0 after:h-0.5 after:bg-red-500 after:transition-all after:duration-300 hover:after:w-full data-[state=active]:after:w-full">Notes</TabsTrigger>
            </TabsList>
