              ...
              <Card className="transition-all duration-700">
                ...
                <CardContent className="space-y-6">
                  <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id="property-type-primary-residence"
                        checked={form.watch('property.propertyTypes.primaryResidence') || false}
                        onCheckedChange={(checked) => handlePropertyTypeChange('property.propertyTypes.primaryResidence', !!checked, 'Primary Residence')}
                        data-testid="checkbox-primary-residence"
                        className="transition-transform duration-500 hover:scale-105 data-[state=checked]:rotate-[360deg]"
                      />
                      <Label htmlFor="property-type-primary-residence">Primary Residence</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id="property-type-second-home"
                        checked={form.watch('property.propertyTypes.secondHome') || false}
                        onCheckedChange={(checked) => handlePropertyTypeChange('property.propertyTypes.secondHome', !!checked, 'Second Home')}
                        data-testid="checkbox-second-home"
                        className="transition-transform duration-500 hover:scale-105 data-[state=checked]:rotate-[360deg]"
                      />
                      <Label htmlFor="property-type-second-home">Second Home</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id="property-type-investment"
                        checked={form.watch('property.propertyTypes.investment') || false}
                        onCheckedChange={(checked) => handlePropertyTypeChange('property.propertyTypes.investment', !!checked, 'Investment')}
                        data-testid="checkbox-investment"
                        className="transition-transform duration-500 hover:scale-105 data-[state=checked]:rotate-[360deg]"
                      />
                      <Label htmlFor="property-type-investment">Investment</Label>
                    </div>
                    <div className="flex items-center space-x-2">
                      <Checkbox
                        id="property-type-home-purchase"
                        checked={form.watch('property.propertyTypes.homePurchase') || false}
                        onCheckedChange={(checked) => handlePropertyTypeChange('property.propertyTypes.homePurchase', !!checked, 'Home Purchase')}
                        data-testid="checkbox-home-purchase"
                        className="transition-transform duration-500 hover:scale-105 data-[state=checked]:rotate-[360deg]"
                      />
                      <Label htmlFor="property-type-home-purchase">Home Purchase</Label>
                    </div>
                  </div>
                </CardContent>
              </Card>
    ...
    <div className="container mx-auto p-6 max-w-7xl">
      <div className="space-y-6">
        <div className="text-center">
          ...
          <p className="text-gray-600 mt-2">Complete loan application form with borrower information</p>
        </div>
