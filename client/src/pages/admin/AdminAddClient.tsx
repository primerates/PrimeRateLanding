        ...
        <form onSubmit={form.handleSubmit(onSubmit)}>
          <Tabs defaultValue="client" className="space-y-6">
            <TabsList className="grid w-full grid-cols-9 bg-transparent h-auto p-0 relative border-b border-gray-200 group">
              <TabsTrigger value="client" data-testid="tab-client" className="relative bg-transparent text-gray-500 hover:text-black data-[state=active]:text-black data-[state=active]:bg-transparent border-0 rounded-none py-3 px-4 font-medium transition-colors duration-200 after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:w-0 after:h-0.5 after:bg-red-500 after:transition-all after:duration-300 hover:after:w-1/2 data-[state=active]:group-hover:after:w-0 data-[state=active]:after:w-1/2">Borrower</TabsTrigger>
              <TabsTrigger value="income" data-testid="tab-income" className="relative bg-transparent text-gray-500 hover:text-black data-[state=active]:text-black data-[state=active]:bg-transparent border-0 rounded-none py-3 px-4 font-medium transition-colors duration-200 after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:w-0 after:h-0.5 after:bg-red-500 after:transition-all after:duration-300 hover:after:w-1/2 data-[state=active]:group-hover:after:w-0 data-[state=active]:after:w-1/2">Income</TabsTrigger>
              <TabsTrigger value="property" data-testid="tab-property" className="relative bg-transparent text-gray-500 hover:text-black data-[state=active]:text-black data-[state=active]:bg-transparent border-0 rounded-none py-3 px-4 font-medium transition-colors duration-200 after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:w-0 after:h-0.5 after:bg-red-500 after:transition-all after:duration-300 hover:after:w-1/2 data-[state=active]:group-hover:after:w-0 data-[state=active]:after:w-1/2">Property</TabsTrigger>
              <TabsTrigger value="loan" data-testid="tab-loan" className="relative bg-transparent text-gray-500 hover:text-black data-[state=active]:text-black data-[state=active]:bg-transparent border-0 rounded-none py-3 px-4 font-medium transition-colors duration-200 after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:w-0 after:h-0.5 after:bg-red-500 after:transition-all after:duration-300 hover:after:w-1/2 data-[state=active]:group-hover:after:w-0 data-[state=active]:after:w-1/2">Loan</TabsTrigger>
              <TabsTrigger value="credit" data-testid="tab-credit" className="relative bg-transparent text-gray-500 hover:text-black data-[state=active]:text-black data-[state=active]:bg-transparent border-0 rounded-none py-3 px-4 font-medium transition-colors duration-200 after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:w-0 after:h-0.5 after:bg-red-500 after:transition-all after:duration-300 hover:after:w-1/2 data-[state=active]:group-hover:after:w-0 data-[state=active]:after:w-1/2">Credit</TabsTrigger>
              <TabsTrigger value="status" data-testid="tab-status" className="relative bg-transparent text-gray-500 hover:text-black data-[state=active]:text-black data-[state=active]:bg-transparent border-0 rounded-none py-3 px-4 font-medium transition-colors duration-200 after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:w-0 after:h-0.5 after:bg-red-500 after:transition-all after:duration-300 hover:after:w-1/2 data-[state=active]:group-hover:after:w-0 data-[state=active]:after:w-1/2">Status</TabsTrigger>
              <TabsTrigger value="vendors" data-testid="tab-vendors" className="relative bg-transparent text-gray-500 hover:text-black data-[state=active]:text-black data-[state=active]:bg-transparent border-0 rounded-none py-3 px-4 font-medium transition-colors duration-200 after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:w-0 after:h-0.5 after:bg-red-500 after:transition-all after:duration-300 hover:after:w-1/2 data-[state=active]:group-hover:after:w-0 data-[state=active]:after:w-1/2">Vendors</TabsTrigger>
              <TabsTrigger value="quote" data-testid="tab-quote" className="relative bg-transparent text-gray-500 hover:text-black data-[state=active]:text-black data-[state=active]:bg-transparent border-0 rounded-none py-3 px-4 font-medium transition-colors duration-200 after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:w-0 after:h-0.5 after:bg-red-500 after:transition-all after:duration-300 hover:after:w-1/2 data-[state=active]:group-hover:after:w-0 data-[state=active]:after:w-1/2">Quote</TabsTrigger>
              <TabsTrigger value="notes" data-testid="tab-notes" className="relative bg-transparent text-gray-500 hover:text-black data-[state=active]:text-black data-[state=active]:bg-transparent border-0 rounded-none py-3 px-4 font-medium transition-colors duration-200 after:absolute after:bottom-0 after:left-1/2 after:-translate-x-1/2 after:w-0 after:h-0.5 after:bg-red-500 after:transition-all after:duration-300 hover:after:w-1/2 data-[state=active]:group-hover:after:w-0 data-[state=active]:after:w-1/2">Notes</TabsTrigger>
            </TabsList>
          ...
          <AlertDialogFooter>
            ...
            <AlertDialogAction 
              onClick={() => {
                ...
                setBorrowerSecondEmployerCards(prev => prev.filter(id => 
                  cardToDelete === 'second-template-card' ? id !== 'default' : id !== cardToDelete
                ));
