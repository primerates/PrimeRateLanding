        ...
        <Card>
          ...
          <CardContent>
            ...
            <ul className="list-disc list-inside space-y-2 text-muted-foreground">
              <li>Add new client profiles to the system</li>
              <li>Enter client contact information and preferences</li>
              <li>Set up loan requirements and parameters</li>
              <li>Assign clients to loan officers</li>
            </ul>
          </CardContent>
        </Card>
      </div>
