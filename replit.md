...
### Admin Features
- **Comments & Posts Management**: System for client testimonials and internal company posts with 6-tab navigation (Client Comment, All Comments, Company Post, All Posts, Posts, Notes), real-time preview, statistics, localStorage persistence, sortable tables, and sticky notes functionality. The "Last Comment" and "Posts" cards (with circular indicators and checkboxes) are only visible when the "Posts" tab is active.
