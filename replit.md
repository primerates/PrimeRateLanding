...
#### Dashboard Tiles
- **Row 1**: Lead, Quote, Loan Prep, Loan (green left border on hover)
- **Row 2**: Funded, Closed, Marketing, Snapshot (blue left border on hover)
- **Row 3**: Staff, Vendors, Library, Settings (purple left border on hover)
